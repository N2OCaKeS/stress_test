    ...
    if page == 'brest':
        ...
        return render_template(f'{page}.html',
                                ...
                                **col3_body,                                                        
                                ...
                                stand3_snap=sorted(partimag()['stand3'].keys()),
                                stand4_snap=sorted(partimag()['stand4'].keys()),
                                stand5_snap=sorted(partimag()['stand5'].keys()),
                                ...
                                stand10_snap=sorted(partimag()['stand10'].keys()),
                                stand11_snap=sorted(partimag()['stand11'].keys()),
                                stand12_snap=sorted(partimag()['stand12'].keys()),
                                stand13_snap=sorted(partimag()['stand13'].keys()),
                                stand14_snap=sorted(partimag()['stand14'].keys()),
