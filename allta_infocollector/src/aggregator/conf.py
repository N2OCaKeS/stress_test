...
full_dashboard = 'http://{server_ip}:3001/d/rYdddlPWk/node-exporter-full?orgId=1&from=now-5m&to=now&timezone=browser&var\
    -datasource=default&var-job=node_exporter&var-node={stand_ip}:9100&var-diskdevices=%5Ba-z%5D%2B%7Cnvme%5B0-9%5D%2Bn%\
        5B0-9%5D%2B%7Cmmcblk%5B0-9%5D%2B&refresh=5s&kiosk'.format(server_ip=server_ip)
