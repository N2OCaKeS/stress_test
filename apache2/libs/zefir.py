...
from libs.libapa import response
from libs.libpublic import Public
from libs.libstatistics import ApacheStatistics
from time import sleep, ctime
from apa_conf import JIRA_URL, CONFLUENCE_URL


class UploaderZC(Public, ApacheStatistics):
    ...
    def test_cycle_status_changer(self, status):
        ...
        if self.statistics == True:
            statistics = ApacheStatistics(username=self.UN, 
                                        token=self.CT)
