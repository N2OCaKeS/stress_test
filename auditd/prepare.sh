...
sudo apt-get install -y libffi-dev strace syslog-ng htop
...
sudo python3.12 -m pip config --global set global.index-url http://allta.devos.astralinux.ru:3141/root/release
sudo python3.12 -m pip config --global set global.trusted-host allta.devos.astralinux.ru
