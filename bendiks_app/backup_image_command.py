...
cz_comm = {
    'stand1':{
        'debian11-5.15':'sudo drbl-ocs -g auto -e1 auto -e2 -r -x -j2 -k0 -sc0 -p reboot -h " 10.177.103.201" \
                -l ru_RU.UTF-8 startdisk restore stand-1-qa-team-13-debian11-5.15 nvme0n1',
