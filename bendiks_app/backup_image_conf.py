...
parent_page_list = {
    ...
    '1.7.5.UU.1.1':{'postgresql':'1.7.5.UU.1.1 ⬝ PostgreSQL',
                ...
                'psql kernels':'1.7.5.UU.1.1 ⬝ PostgreSQL',
                ...
                'NTFS':'1.7.5.UU.1.1 ⬝  Файловые системы',
                'XFS parsec':'1.7.5.UU.1.1 ⬝  Файловые системы',
                'auditd-p':'1.7.5.UU.1.1 ⬝ Системные службы',
                'auditd-f':'1.7.5.UU.1.1 ⬝ Системные службы',
                'auditd-u':'1.7.5.UU.1.1 ⬝ Системные службы',
    ...
    '1.7.5.UU.1':{'postgresql':'1.7.5.UU.1 ⬝ PostgreSQL',
                ...
                'psql kernels':'1.7.5.UU.1 ⬝ PostgreSQL',
                ...
                'NTFS':'1.7.5.UU.1 ⬝ Файловые системы',
                'XFS parsec':'1.7.5.UU.1 ⬝ Файловые системы',
                'auditd-p':'1.7.5.UU.1 ⬝ Системные службы',
                'auditd-f':'1.7.5.UU.1 ⬝ Системные службы',
                'auditd-u':'1.7.5.UU.1 ⬝ Системные службы',
    ...
    '1.7.3.UU.1':{'postgresql':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'postgresql-sm':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'psql kernels':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'psql parsec':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'psql vanilla':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'postgresql-aud-off':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'tantor vanilla':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
                  'tantor kernels':'STRESS 1.7.3.UU.1 ⬝ PostgreSQL',
...
#################################################################################################################################################
releases = ['1.7.1', '1.7.2', '1.7.3', '1.7.3.UU.1', '1.7.3.UU.2', '1.7.4', '1.7.4.UU.1', '1.7.5', '1.8.0.1', '1.7.5.UU.1.1']
