...
sudo sed -i 's|ExecStart=/usr/local/bin/containerd|ExecStart=/usr/bin/containerd|g' /lib/systemd/system/containerd.service && sudo systemctl daemon-reload && echo "Исправлено, ждем 10 секунд..." && sleep 10