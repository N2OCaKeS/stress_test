...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'department_docker_registry', 'departments', ['department_id'], ['id'], ondelete='CASCADE')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'department_docker_registry', type_='foreignkey')
    # ### end Alembic commands ###
