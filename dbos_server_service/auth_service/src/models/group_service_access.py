...
class GroupServiceAccess(Base):
    __tablename__ = "group_service_access"
    __table_args__ = (
        UniqueConstraint("group_id", "service_name", name="uq_group_service_access"),
    )
    ...
    group: Mapped["UserGroup"] = relationship("UserGroup", back_populates="service_access")  # noqa: F821
