...
# ── GET /events под audit_query_rate_limit ──────────────────────────
...
# ── register_events пишет self-audit ──────────────────────────────────
...
# ── introspect transport-exception не светит имя класса ─────────────
...
# ── update_rule отличает UNIQUE от прочих IntegrityError ─────────────
...
# ── register_events re-register (added=0, updated=N) ─────────────────
