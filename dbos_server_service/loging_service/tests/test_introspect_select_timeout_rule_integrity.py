...
# ── auth.py не светит upstream HTTP-статус в user-facing 503 ─────────
...
# ── основной SELECT тоже под statement_timeout ──────────────────────
...
# ── outbox drained_total бампится только на successful savepoint'ы ──
...
# ── create_rule различает UniqueViolation и прочие IntegrityError ───
