...
* boundary values — rotated_at exactly at 600s skew boundary;
  naive datetime service-level defence (unit path)
"""
...
class TestSubjectTypeInDeniedAudit:
    ...
    Integration-тест, что реальный endpoint-emit содержит subject_type
    для bot-caller'а.
    """
...
# ─────────────────────────────────────────────────────────────────────────────
# 6. rotated_at boundary value — ровно 600s
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# 7. naive datetime service-level defence
# ─────────────────────────────────────────────────────────────────────────────
