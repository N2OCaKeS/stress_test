...
_KV_SECRET_RE = re.compile(
    r"(?i)\b(secret|secret_key|api_key|apikey|client_secret|private_key|"
    r"signing_key)\s*[=:]\s*"
    r"(?P<val>[^\s&,;]+)",
)
