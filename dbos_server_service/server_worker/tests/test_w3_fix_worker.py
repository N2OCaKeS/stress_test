"""Regression: P0/P1 фиксы на server_worker (волна 3).
...
# ── P0 #1: ssh.py login regex .fullmatch ────────────────────────────────────
...
# ── P1 #3: unknown task_kind floor backoff ──────────────────────────────────
...
# ── P1 #4: _drain_running_tasks не трогает QUEUED row ───────────────────────
...
# ── P1 #5: record_success exception не вызывает re-publish ─────────────────
...
# ── P1 #6: ValueError ветка secrets_reencrypt_lazy ──────────────────────────
...
# ── #7: dispatch_outbox idempotency cap + _filter_result_for_audit sentinels ──
