...
const GROUPS_MOCK: UserGroup[] = [
  ...
  },
  {
    ...
    label: "Разработка · 12",
    rows: [
      { name: "sam", role: { label: "dep_admin", kind: "plain" }, dept: "Разработка", lastSeen: "30 мин", status: { label: "active", kind: "ok" }, isCog: true },
      { name: "tina", dept: "Разработка", lastSeen: "5 мин", status: { label: "active", kind: "ok" } },
      { name: "ulrich", dept: "Разработка", lastSeen: "40 мин", status: { label: "active", kind: "ok" } },
      { name: "vera", dept: "Разработка", lastSeen: "1 ч", status: { label: "active", kind: "ok" } },
      { name: "walter", dept: "Разработка", lastSeen: "15 мин", status: { label: "active", kind: "ok" } },
      { name: "xenia", dept: "Разработка", lastSeen: "3 ч", status: { label: "active", kind: "ok" } },
      { name: "yara", dept: "Разработка", lastSeen: "14 дн", status: { label: "banned", kind: "danger" } },
      { name: "zane", dept: "Разработка", lastSeen: "2 ч", status: { label: "active", kind: "ok" } },
      { name: "artem", dept: "Разработка", lastSeen: "4 ч", status: { label: "active", kind: "ok" } },
      { name: "boris", dept: "Разработка", lastSeen: "5 дн", status: { label: "blocked", kind: "warn" } },
      { name: "bot-jira-dev", role: { label: "bot", kind: "plain" }, dept: "Разработка", lastSeen: "1 мин", status: { label: "active", kind: "ok" }, isBot: true },
      { name: "bot-build-dev", role: { label: "bot", kind: "plain" }, dept: "Разработка", lastSeen: "7 мин", status: { label: "active", kind: "ok" }, isBot: true },
    ],
  },
  {
    icon: "building",
