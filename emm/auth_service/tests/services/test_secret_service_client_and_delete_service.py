"""Регрессии по интеграции auth_service с secret_service.
...
# ── X-Service-Identity outbound + PII redaction ─────────────
...
# ── BulkRoleRequest.user_ids max_length=200 ─────────────────────────
...
# ── delete_service group cascade + per-dept emit ──────────────
