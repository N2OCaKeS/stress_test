...
# ── action_is_registered LIKE-фильтр в БД ──────────────────────────
...
# ── _validate_match_action использует has_any_registered ────────────
...
# ── apply_active snapshot фиксируется (документация-as-test) ────────
...
# ── _retention_loop last_run не теряется при упавшем commit'е ───────
...
# ── register_events — single advertised read ────────────────────────
...
# ── _action_for_path segment-walk (sanity) ──────────────────────────
...
# ── RuleCreate.match_service — uppercase отбивается ─────────────────
...
# ── _RuleSnapshot.effect Literal alias smoke ────────────────────────
...
# ── _validate_request_id единый regex ───────────────────────────────
