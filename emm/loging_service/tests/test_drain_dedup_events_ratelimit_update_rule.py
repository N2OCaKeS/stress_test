"""Точечные unit'ы под три фикса loging_service: drain-dedup, events rate-limit, update_rule.
...
# ── drain CancelledError не дублирует уже-закоммитнутые events ──────
...
# ── update_rule — pgcode симметрия с create_rule ────────────────────
