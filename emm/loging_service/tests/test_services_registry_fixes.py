...
# ── rate-limit + offset cap на read-эндпоинты реестра сервисов ─────
...
# ── register_events truncate actor_id ─────────────────────────────
...
# ── rule_repo.delete soft-rename collision ─────────────────────────
...
# ── _fetch_identity fallback на anonymous ──────────────────────────
...
# ── limit_body_size chunked + 4xx route ────────────────────────────
