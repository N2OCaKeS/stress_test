...
class TestListAll:
    async def test_dept_admin_lists_default_grants(self, client, admin_token):
        ...
        # 9 строк (4 secret-access + server.inventory_submit +
        ...
        # server.view_management_credentials для per-server mgmt-кред),
        ...
        assert len(worker_bot_grants) == 9
...
class TestListForEntity:
    async def test_filters_by_entity(self, client, admin_token):
        ...
        # acs_snapshot → 17, c4e91a7f3d68 добавил view_test_credentials → 18.
