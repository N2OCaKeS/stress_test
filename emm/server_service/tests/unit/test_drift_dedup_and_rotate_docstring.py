...
# ── permission → visibility в users_inventory ────────────────────────
...
# ── missing_on_box drift — только на True → False переходе ───────────
...
# ── rotate_credentials docstring/summary ─────────────────────────────
...
# ── discovered без пароля требует force_password=true ────────────────
...
# ── системные task'и опознаются по whitelist task_kind ───────────────
