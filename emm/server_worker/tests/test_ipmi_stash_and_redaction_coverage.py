"""Точечные сценарии по stash-парсеру, редакции и runner-хелперам.

  * _ipmi_stash_parse: backward-compat plain-string path (non-JSON → (text, None)),
    bytes input, str input, JSON с non-dict top-level, пустой JSON.
  * _KV_SECRET_RE именованные варианты в redact_error_message:
    client_secret=, private_key=, signing_key=, apikey= → <SECRET>.
  * _account_creds: is_managed=True + полностью отсутствующий ключ login
    (не None, а отсутствие в dict) → SSH_INVALID_ARG.
  * _filter_result_for_audit unit-level: все ветки (None, no_whitelist,
    not_dict, filtered).
  * _cancel_timestamp unit: task=None, cancelled_at=None, cancelled_at set.
  * _recover_due_scheduled_retries_once: exception ловится, worker не падает.
"""
...
# ══════════════════════════════════════════════════════════════════════════════
# _ipmi_stash_parse — backward-compat plain-string path
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# _account_creds — отсутствующий ключ login при is_managed=True
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# _filter_result_for_audit — unit-level все ветки
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# _cancel_timestamp — unit-level все ветки
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# _recover_due_scheduled_retries_once — exception не крашит
# ══════════════════════════════════════════════════════════════════════════════
