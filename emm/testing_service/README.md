...
**Текущий статус — волна 1 (каркас).** Модели, эндпоинты домена и воркер-задачи ещё не реализованы. Этот README описывает то, что реально есть в коде; по мере реализации волн 2-12 (`obsidian/ALLTA MIGRATION.md` §16) секции наполнятся.
