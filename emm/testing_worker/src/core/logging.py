...
# server_service/secret_service/server_worker/testing_service — общего
# импорта между сервисами нет (изолированный PYTHONPATH), поэтому каждый
# держит свою копию. При правке в одном месте — синхронизировать руками во
# все остальные.
...
Использование в `main.py`:
    ...
    configure_logging("testing_worker", level=settings.worker_log_level)
"""
