...
DESCRIPTION = {
    "auth": "Система нагрузочного тестирования демона astra-freeipa-server. Специальным образом в системе строятся процессы-генераторы для одновременной аутентификации. Далее все необходимые зависимости будут представлены в графическом виде.",
    "create-users": "Тест производительности astra-freeipa-server. Cоздается от 1000 до 5000 пользователей с шагом 1000. Время создания пользователей фиксируется и отображается в отчете.",
    "plugin": "Тест производительности плагина memberOf при добавлении 50000 пользователей из одной группы в другую. Время выполнения операции добавления пользователей из одной группы в другую фиксируется и отображается в отчете.",
}
