...
def add_arguments(parser):
    ...
    parser.add_argument('--use_kinit', action='store_true', default=False, help='Получение билета Kerberos')
    parser.add_argument('--use_dns', action='store_true', default=False, help='Отправить DNS запрос')
    parser.add_argument('--use_search', action='store_true', default=False, help='Поиск записей через LDAP search')
    ...
    parser.add_argument('--ldap-bind-dn', type=str, default='uid=admin,cn=users,cn=accounts,dc=stress-testing,dc=local')
    ...
    parser.add_argument('--ldap-search-base', type=str, default='cn=users,cn=accounts,dc=stress-testing,dc=local')
    ...
    parser.add_argument('--kerberos-realm', type=str, default='STRESS-TESTING.LOCAL')
