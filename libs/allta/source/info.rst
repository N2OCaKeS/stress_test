...
.. csv-table:: 
   ...
   "1.1.7", "mfilippenko", "Добавлена отказоустойчивость при ошибках публикации в Confuence"
   "1.1.8", "mfilippenko", "Обновлена математическая модель"   
   "1.1.9", "mfilippenko", "Обновлена математическая модель добавлен режим ratio-рейтинга"
   "1.2.0", "mfilippenko", "ratio-режим: total_rating возвращает (total, criteria) с baseline/result/index по критериям"
