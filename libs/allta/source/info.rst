...
.. csv-table:: 
   ...
   "1.0.12", "mfilippenko", "Добавлена подержка disk для изменения размера диска ВМ при сборке и есть возможность сразу создать ВМ с ip в 103 подсети, создан LibvirtManager.Command.generator()"
