...
.. note::
   Автор: команда ``mfilippenko``. Класс отвечает за публикацию HTML-страниц и вложений в Confluence, включая построение версионного дерева страниц для stress-отчётов.
