...
|---|---|
| `DEVPI_DATA_DIR` | Каталог хранилища пакетов на хосте (bind-mount в `/data`). По умолчанию `/home/partimage/devpi`. |
...
Пакеты хранятся на хосте в `DEVPI_DATA_DIR` (по умолчанию `/home/partimage/devpi`),
