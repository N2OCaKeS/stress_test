...
"""
    TODO переименовать конфигурационный файл
"""
from psb_conf import INFO_FILENAME, GRAPH_DESCRIPTIONS, REPORT_PATH, TEMPLATE_PATH
...
with open('{}/header_table_template.html'.format(args.T_PATH), 'r') as file:
    ...
    header_table = header_table_temp.format(av=info_lst[0],
                                            ...
                                            # TODO дописать необходимые параметры
...
"""
    TODO  Переименовать файл с отчетом
"""
...
"""
    TODO Переименовать файл с с таблицей
"""
