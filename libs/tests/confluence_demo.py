...
def build_demo_page() -> tuple[PageBuilder, Path]:
    ...
    builder.add_table(
        {
            "title": "Быстрые факты",
            "headers": ["clients", "la", 'tps'],
            "rows": [
                {"clients": "500", "la": "44,094", "tps": "120"},
                {"clients": "400", "la": "29,797", "tps": "100"},
            ],
        }
    )
    builder.add_chart(
        [
            {
                ...
                "type": "line",
                "x_key": "T",
                "series": ["throughput", "throughput_p95"],
                "series_colors": {
                    "throughput": "#0052CC",
                ...
                "data": [
                    {"T": "T+00", "throughput": 8.1, "throughput_p95": 8.6},
                    {"T": "T+05", "throughput": 8.4, "throughput_p95": 8.9},
                    {"T": "T+10", "throughput": 8.0, "throughput_p95": 8.3},
                ],
            },
            {
                "title": "Area",
                "type": "area",
                "x_key": "T",
                "series": ["latency_p50", "latency_p95"],
                ...
                "data": [
                    {"T": "T+00", "latency_p50": 210, "latency_p95": 260},
                    {"T": "T+05", "latency_p50": 180, "latency_p95": 230},
                    {"T": "T+10", "latency_p50": 220, "latency_p95": 280},
                ],
            },
            {
                "title": "Bar",
                ...
                "y_label": "Тест-кейсы",
                "data": [
                    {"Неделя": "W1", "Passed": 320, "Failed": 12},
                    {"Неделя": "W2", "Passed": 340, "Failed": 9},
                    {"Неделя": "W3", "Passed": 330, "Failed": 5},
                ],
            },
            {
                "title": "Column",
                ...
                "y_label": "Ошибки (%)",
                "data": [
                    {"Неделя": "W1", "Ошибки": 8.8},
                    {"Неделя": "W2", "Ошибки": 6.6},
                    {"Неделя": "W3", "Ошибки": 1.4},
                ],
            },
            {
                "title": "Pie",
                ...
                "data": [
                    ...
                    {"Категория": "UI", "value": 25},
                    {"Категория": "DB", "value": 20},
                    {"Категория": "Cache", "value": 15},
                ],
                "view_table": True,
            },
        ],
