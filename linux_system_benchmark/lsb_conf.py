...
GRAPH_DESCRIPTIONS = {
    'lsb_dhry2reg_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_whetstone-double_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_execl_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_fstime_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '    <li><b>OY</b>: KBps;</li>'
                                      '</ul></p>',
    'lsb_fsbuffer_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '    <li><b>OY</b>: KBps;</li>'
                                      '</ul></p>',
    'lsb_fsdisk_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '    <li><b>OY</b>: KBps;</li>'
                                      '</ul></p>',
    'lsb_pipe_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_context1_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_spawn_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_shell1_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '</ul></p>',
    'lsb_shell8_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
                                      ...
                                      '    <li><b>OY</b>: Количество запусков в минуту (lpm);</li>'
                                      '</ul></p>',
    'lsb_syscall_parallel_threads_value_graph.png': '<p style="font-family: Century Gothic, sans-serif; font-size: 14px;">'
