...
# 1. Гоним тест
kernel = KernelLoad(rc_name=TEST_CYCLE_VERSION, testdir=BASE_PATH, vm_count=KERNEL_NET_VM_COUNT, kernel=KERNEL, vcpu=KERNEL_NET_VCPU, ram=KERNEL_NET_RAM)
kernel.prepare_vms()
kernel.start_test()
