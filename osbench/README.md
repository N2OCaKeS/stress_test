...
При этом внутри каждой подсистемы веса тестов распределены так, что их сумма равна 100%.
...
| **fsync_avg** | fs_mark | Среднее время синхронизации файлов (fsync). |
...
- Тесты, проверенные временем (UnixBench, LMbench, Perf, fs_mark)
