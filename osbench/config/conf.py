...
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│\033[1;33m  {test:<35} {guideline:>19} {result:>12} {ratio:>12}                   \033[0m │
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  syscall                                   {syscall_guideline:>12.1f}    {syscall_result:>10.1f}    {syscall_ratio:>9.3f}
│  lat_syscall null                          {lat_syscall_null_guideline:>12.4f}    {lat_syscall_null_result:>10.4f}    {lat_syscall_null_ratio:>9.3f}
│  lat_syscall read                          {lat_syscall_read_guideline:>12.4f}    {lat_syscall_read_result:>10.4f}    {lat_syscall_read_ratio:>9.3f}
│  lat_syscall write                         {lat_syscall_write_guideline:>12.4f}    {lat_syscall_write_result:>10.4f}    {lat_syscall_write_ratio:>9.3f}
│  lat_ctx                                   {lat_ctx_guideline:>12.1f}    {lat_ctx_result:>10.1f}    {lat_ctx_ratio:>9.3f}
│  sched pipe                                {sched_pipe_guideline:>12.1f}    {sched_pipe_result:>10.3f}    {sched_pipe_ratio:>9.3f}
│  sched messaging                           {sched_messaging_guideline:>12.3f}    {sched_messaging_result:>10.3f}    {sched_messaging_ratio:>9.3f}
│  futex hash                                {futex_hash_guideline:>12.0f}    {futex_hash_result:>10.0f}    {futex_hash_ratio:>9.3f}
│  futex wake                                {futex_wake_guideline:>12.1f}    {futex_wake_result:>10.1f}    {futex_wake_ratio:>9.3f}
│  futex requeue                             {futex_requeue_guideline:>12.1f}    {futex_requeue_result:>10.1f}    {futex_requeue_ratio:>9.3f}
│  epoll wait                                {epoll_wait_guideline:>12.0f}    {epoll_wait_result:>10.0f}    {epoll_wait_ratio:>9.3f}
│  epoll ctl                                 {epoll_ctl_guideline:>12.0f}    {epoll_ctl_result:>10.0f}    {epoll_ctl_ratio:>9.3f}
│  lat_sig install                           {lat_sig_install_guideline:>12.4f}    {lat_sig_install_result:>10.4f}    {lat_sig_install_ratio:>9.3f}
│  lat_sig catch                             {lat_sig_catch_guideline:>12.4f}    {lat_sig_catch_result:>10.4f}    {lat_sig_catch_ratio:>9.3f}
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  ИТОГО:\033[1;32m                                                                 {kernel:>10.1f}\033[0m
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│\033[1;33m  {test:<35} {guideline:>19} {result:>12} {ratio:>12}                  \033[0m  │
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  spawn                                     {spawn_guideline:>12.1f}    {spawn_result:>10.1f}    {spawn_ratio:>9.3f}
│  execl                                     {execl_guideline:>12.1f}    {execl_result:>10.1f}    {execl_ratio:>9.3f}
│  lat_proc fork                             {lat_proc_fork_guideline:>12.4f}    {lat_proc_fork_result:>10.4f}    {lat_proc_fork_ratio:>9.3f}
│  lat_proc exec                             {lat_proc_exec_guideline:>12.4f}    {lat_proc_exec_result:>10.4f}    {lat_proc_exec_ratio:>9.3f}
│  pipe                                      {pipe_guideline:>12.0f}    {pipe_result:>10.0f}    {pipe_ratio:>9.3f}
│  context1                                  {context1_guideline:>12.1f}    {context1_result:>10.1f}    {context1_ratio:>9.3f}
│  lat_pipe                                  {lat_pipe_guideline:>12.4f}    {lat_pipe_result:>10.4f}    {lat_pipe_ratio:>9.3f}
│  bw_pipe                                   {bw_pipe_guideline:>12.2f}    {bw_pipe_result:>10.2f}    {bw_pipe_ratio:>9.3f}
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  ИТОГО:    \033[1;32m                                                             {processes_ipc:>10.1f}\033[0m
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ \033[1;33m {test:<35} {guideline:>19} {result:>12} {ratio:>12}                 \033[0m   │
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  bw_file_rd                                {bw_file_rd_guideline:>12.2f}    {bw_file_rd_result:>10.2f}    {bw_file_rd_ratio:>9.3f}
│  fstime                                    {fstime_guideline:>12.0f}    {fstime_result:>10.0f}    {fstime_ratio:>9.3f}
│  fsbuffer                                  {fsbuffer_guideline:>12.0f}    {fsbuffer_result:>10.0f}    {fsbuffer_ratio:>9.3f}
│  fsdisk                                    {fsdisk_guideline:>12.0f}    {fsdisk_result:>10.0f}    {fsdisk_ratio:>9.3f}
│  lat_fs 0K                                 {lat_fs_0K_guideline:>12.0f}    {lat_fs_0K_result:>10.0f}    {lat_fs_0K_ratio:>9.3f}
│  lat_fs 10K                                {lat_fs_10K_guideline:>12.0f}    {lat_fs_10K_result:>10.0f}    {lat_fs_10K_ratio:>9.3f}
│  speed                                     {speed_guideline:>12.1f}    {speed_result:>10.1f}    {speed_ratio:>9.3f}
│  app_overhead                              {app_overhead_guideline:>12.0f}    {app_overhead_result:>10.0f}    {app_overhead_ratio:>9.3f}
│  create_avg                                {create_avg_guideline:>12.1f}    {create_avg_result:>10.1f}    {create_avg_ratio:>9.3f}
│  write_avg                                 {write_avg_guideline:>12.1f}    {write_avg_result:>10.1f}    {write_avg_ratio:>9.3f}
│  fsync_avg                                 {fsync_avg_guideline:>12.1f}    {fsync_avg_result:>10.1f}    {fsync_avg_ratio:>9.3f}
│  close_avg                                 {close_avg_guideline:>12.1f}    {close_avg_result:>10.1f}    {close_avg_ratio:>9.3f}
│  unlink_avg                                {unlink_avg_guideline:>12.1f}    {unlink_avg_result:>10.1f}    {unlink_avg_ratio:>9.3f}
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  ИТОГО:        \033[1;32m                                                         {filesystem:>10.1f}\033[0m
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
│ \033[1;33m {test:<35} {guideline:>19} {result:>12} {ratio:>12}                  \033[0m  │
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  shell1                                    {shell1_guideline:>12.1f}    {shell1_result:>10.1f}    {shell1_ratio:>9.3f}
│  shell8                                    {shell8_guideline:>12.1f}    {shell8_result:>10.1f}    {shell8_ratio:>9.3f}
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  ИТОГО:      \033[1;32m                                                           {scripts:>10.1f}\033[0m
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
├───────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  Общий индекс                                                 \033[1;35m{total:>10.1f}\033[0m
└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
"""
