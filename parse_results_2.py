...
def pivot_metric(df, metric, label):
...
if __name__ == "__main__":
    ...
    pivot_metric(df, "requests_per_second", "Requests per second [#/sec]")
    pivot_metric(df, "waiting_median_ms",   "Waiting median [ms]")
