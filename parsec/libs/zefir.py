...
from libs.libparsec import response
from libs.libpublic import Public
from libs.libstatistics import ParsecStatistics
from time import sleep, ctime
from ps_conf import JIRA_URL, CONFLUENCE_URL


class UploaderZC(Public, ParsecStatistics):
    ...
    def test_cycle_status_changer(self, status):
        ...
        if self.statistics == True:
            statistics = ParsecStatistics(username=self.UN, 
                                        token=self.CT)
