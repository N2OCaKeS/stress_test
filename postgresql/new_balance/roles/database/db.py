...
EOF"""
        ...
        start_cluster = {
            'database1': {
                ...
                "pgbench manual": {
                    "command": f"sudo su - postgres -c \"psql -p {POSTGRES_PORT} -c \'CREATE DATABASE test;\'\" && sleep 50 && pgbench -i -s 100 -h {VMS_DATES['database1']['ip_bridge']} -p {POSTGRES_PORT} -U postgres contrprimer",
