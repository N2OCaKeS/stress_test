...
class ZefirResultTable:
    ...
    def __init__(self,
        ...
        testname_columns = {'file system benchmark. EXT4':'FS_EXT4', 'file system benchmark. XFS':'FS_XFS', 
                            ...
                            'auditd benchmark. psaud':'Auditd_psaud', 'linux_system_benchmark. UnixBench':'LS_UnixBench',
        ...
        with open('git/stress_test/syslog_ng/templates/stand.html', 'r') as r:
            stand = r.read()
        with open('git/stress_test/syslog_ng/templates/times.html', 'r') as r:
            times = r.read()
